...
const features = [
  {
    ...
    description: 'Leverage advanced machine learning algorithms to create highly personalized email campaigns that resonate with each subscriber.',
    icon: (
  ...
  },
  {
    ...
    description: 'Create sophisticated email workflows that automatically engage your audience at the perfect moment.',
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  },
  {
    ...
    description: 'Gain deep insights into your campaign performance with comprehensive analytics and reporting tools.',
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  },
  {
    ...
    description: 'Efficiently manage and segment your subscriber lists for targeted campaigns and better engagement.',
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="mt-6 max-w-2xl mx-auto text-xl text-gray-200">
              Everything you need to create, automate, and optimize your email campaigns with AI-powered intelligence.
            </p>
          </motion.div>
        </div>
      </div>
