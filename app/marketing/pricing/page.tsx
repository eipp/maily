  ...
  return (
    <div className="bg-white">
      ...
      <div className="relative bg-primary">
        <div className="max-w-7xl mx-auto pt-24 pb-16 px-4 sm:px-6 lg:px-8 text-center">
          <motion.h1
          ...
          <div className="mt-12 flex justify-center">
            <div className="relative self-center rounded-lg bg-primary-dark p-0.5 flex sm:mt-0">
              <button
                type="button"
                onClick={() => setIsYearly(false)}
                className={`${
                  !isYearly ? 'bg-white text-gray-900' : 'text-gray-200'
                } relative py-2 px-6 border-transparent rounded-md text-sm font-medium whitespace-nowrap focus:outline-none focus:z-10 sm:w-auto transition-colors`}
              >
                Monthly billing
              </button>
              <button
                ...
                className={`${
                  isYearly ? 'bg-white text-gray-900' : 'text-gray-200'
                } ml-0.5 relative py-2 px-6 border-transparent rounded-md text-sm font-medium whitespace-nowrap focus:outline-none focus:z-10 sm:w-auto transition-colors`}
              >
                Yearly billing
              </button>
            </div>
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          {plans.map((plan, planIdx) => (
            ...
            >
              ...
              <a
                href={plan.name === 'Enterprise' ? '/marketing/contact' : 'https://app.justmaily.com/auth/signup'}
                className={`mt-8 block w-full rounded-md py-3 px-6 text-center text-sm font-medium ${
                  plan.popular
        ...
        <div className="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
            ...
            <div>
              ...
              <p className="mt-2 text-gray-500">
                We'll notify you when you're approaching your limit. You can upgrade to a higher plan or remove inactive subscribers.
              </p>
            </div>
            <div>
              <h3 className="text-lg font-medium text-gray-900">
