...
export default function Footer() {
  const footerLinks = {
    ...
    Company: [
      ...
      { href: '/marketing/careers', label: 'Careers' },
    ],
    Legal: [
      { href: '/marketing/legal/terms', label: 'Terms' },
      { href: '/marketing/legal/privacy', label: 'Privacy' },
    ],
    Social: [
      { href: 'https://twitter.com/justmaily', label: 'Twitter', icon: 'twitter' },
      { href: 'https://linkedin.com/company/justmaily', label: 'LinkedIn', icon: 'linkedin' },
      { href: 'https://github.com/justmaily', label: 'GitHub', icon: 'github' },
    ],
  };
        ...
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8 xl:col-span-1">
            ...
            <p className="text-gray-500 text-base">
              Revolutionize your email marketing with AI-powered automation and personalization.
            </p>
