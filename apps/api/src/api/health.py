...
from apps.api.src.utils.resilience import get_circuit_breaker
...
async def check_database_health() -> ComponentHealth:
    ...
    try:
        ...
        from apps.api.src.utils.db_session import get_db
...
async def check_ai_service_health() -> ComponentHealth:
    ...
    try:
        # Import here to avoid circular imports
        from apps.api.src.services.ai_service import AIService
...
async def get_circuit_breaker_statuses() -> List[CircuitBreakerStatus]:
    ...
    from apps.api.src.utils.resilience import _circuit_breakers
