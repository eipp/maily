...
DKIM_SELECTOR="mail"
DKIM_PUBLIC_KEY=""
MX_RECORDS="10 mx1.maily.com,20 mx2.maily.com"
SPF_RECORD="v=spf1 mx a include:_spf.maily.com ~all"
DMARC_RECORD="v=DMARC1; p=reject; sp=reject; adkim=s; aspf=s; rua=mailto:dmarc@maily.com; ruf=mailto:dmarc@maily.com; fo=1; pct=100"
CAA_RECORDS="0 issue \"letsencrypt.org\",0 issuewild \"letsencrypt.org\",0 iodef \"mailto:security@maily.com\""
TTL=3600
PROXIED=true
